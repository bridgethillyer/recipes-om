...
var f = (function (){var pred__34394 = cljs.core._EQ_;
var expr__34395 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34394.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34395))){
return ((function (pred__34394,expr__34395){
return (function (p1__34387_SHARP_){
return console.warn(p1__34387_SHARP_);
});
;})(pred__34394,expr__34395))
} else {
if(cljs.core.truth_(pred__34394.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34395))){
return ((function (pred__34394,expr__34395){
return (function (p1__34388_SHARP_){
return console.debug(p1__34388_SHARP_);
});
;})(pred__34394,expr__34395))
} else {
if(cljs.core.truth_(pred__34394.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34395))){
return ((function (pred__34394,expr__34395){
return (function (p1__34389_SHARP_){
return console.error(p1__34389_SHARP_);
});
;})(pred__34394,expr__34395))
} else {
return ((function (pred__34394,expr__34395){
return (function (p1__34390_SHARP_){
return console.log(p1__34390_SHARP_);
});
;})(pred__34394,expr__34395))
}
}
